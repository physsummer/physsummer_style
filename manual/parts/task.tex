...
команду \texttt{newline} или \texttt{\textbackslash\textbackslash}. (Вторая из
них допускает опциональный аргумент, задающий дополнительный вертикальный
отступ, например \texttt{\textbackslash\textbackslash[2mm]}) Данной ошибки не должно возникать при
